            ...
            {member.instagram && (
              <div className="mt-6 pt-4 border-t border-luxury-border/20 text-center">
                <a 
                  ...
                  className="font-sans text-[9px] tracking-wider text-luxury-gold hover:text-white transition-colors duration-300 italic font-bold flex items-center justify-center gap-1"
                >
